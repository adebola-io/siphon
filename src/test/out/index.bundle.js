...
function _einit6fa_ () {
  ...
  const _emodule89e$0_ = _einit1ca_();
  const _emodule7c7$1_ = _einita44_();
  const utils = _emodule89e$0_.default;
  const Typescript = _emodule7c7$1_;
...
function _einit1ca_ () {
  ...
  _einit1ca_.default = { "name": "sefunmi" };
  return _einit1ca_;
}
var _ecb5_ = 0;
function _einita44_ () {
      ...
      function (
        ...
        var JSXParser = (function (_super) {
          ...
          JSXParser.prototype.parseComplexJSXElement = function (el) {
            ...
            while (!this.scanner.eof()) {
              ...
              if (element.type === jsx_syntax_1.JSXSyntax.JSXClosingElement) {
                ...
                if (stack.length > 0) {
                  var child = this.finalize(el.node, new JSXNode.JSXElement(
                    el.opening, 
                    el.children, 
                    el.closing
                  ));
          ...
          JSXParser.prototype.parseJSXElement = function () {
            ...
            return this.finalize(node, new JSXNode.JSXElement(
              opening, 
              children, 
              closing
            ));
      ...
      function (module, exports) {
        ...
        exports.Character = { 
          ...
          isLineTerminator: function (cp) {
            return cp === Ox0A || cp === Ox0D || cp === Ox2028 || cp === Ox2029;
          }, 
          isIdentifierStart: function (cp) {
            return cp === Ox24 || cp === Ox5F || cp >= Ox41 && cp <= Ox5A || cp >= Ox61 && cp <= Ox7A || cp === Ox5C || cp >= Ox80 && Regex.NonAsciiIdentifierStart.test(exports.Character.fromCodePoint(cp));
          }, 
          isIdentifierPart: function (cp) {
            return cp === Ox24 || cp === Ox5F || cp >= Ox41 && cp <= Ox5A || cp >= Ox61 && cp <= Ox7A || cp >= Ox30 && cp <= Ox39 || cp === Ox5C || cp >= Ox80 && Regex.NonAsciiIdentifierPart.test(exports.Character.fromCodePoint(cp));
          }, 
          isDecimalDigit: function (cp) {
            return cp >= Ox30 && cp <= Ox39;
          }, 
          isHexDigit: function (cp) {
            return cp >= Ox30 && cp <= Ox39 || cp >= Ox41 && cp <= Ox46 || cp >= Ox61 && cp <= Ox66;
          }, 
          isOctalDigit: function (cp) {
            return cp >= Ox30 && cp <= Ox37;
          }
         };
      }, 
      function (
      ...
      function (
        ...
        var Parser = (function () {
          ...
          Parser.prototype.throwError = function (messageFormat) {
            ...
            var msg = messageFormat.replace(/%(\d)/, function (whole, idx) {
            ...
            if (!this.config.comment) {
              ...
              if (comments.length > 0 && this.delegate) {
                for (var i = 0; i < comments.length; ++i) {
                  var e = comments[i];
                  var node = void 0;
                  node = { type: e.multiLine 
                    ? 'BlockComment'
                    : 'LineComment', value: this.scanner.source.slice(e.slice[0], e.slice[1]) };
              ...
              case 7:
                switch (this.lookahead.value) {
                  ...
                  case '/=':
                    ...
                    raw = this.getTokenRaw(token);
                    expr = this.finalize(node, new Node.RegexLiteral(
                      token.regex, 
                      raw, 
                      token.pattern, 
                      token.flags
          ...
          Parser.prototype.parsePropertyMethodFunction = function () {
            ...
            return this.finalize(node, new Node.FunctionExpression(
              null, 
              params.params, 
              method, 
              isGenerator
          ...
          Parser.prototype.parsePropertyMethodAsyncFunction = function () {
            ...
            return this.finalize(node, new Node.AsyncFunctionExpression(
              null, 
              params.params, 
              method
            ));
          ...
          Parser.prototype.parseObjectProperty = function (hasProto) {
            ...
            return this.finalize(node, new Node.Property(
              kind, 
              key, 
              computed, 
              value, 
          ...
          Parser.prototype.parseUpdateExpression = function () {
            ...
            if (this.match('++') || this.match('--')) {
              ...
              var prefix = true;
              expr = this.finalize(node, new Node.UpdateExpression(
                token.value, 
                expr, 
                prefix
              ));
              ...
              if (!this.hasLineTerminator && this.lookahead.type === 7) {
                if (this.match('++') || this.match('--')) {
                  ...
                  var prefix = false;
                  expr = this.finalize(this.startNode(startToken), new Node.UpdateExpression(
                    operator, 
                    expr, 
                    prefix
                  ));
          ...
          Parser.prototype.parseExponentiationExpression = function () {
            ...
            if (expr.type !== syntax_1.Syntax.UnaryExpression && this.match('**')) {
              ...
              expr = this.finalize(this.startNode(startToken), new Node.BinaryExpression(
                '**', 
                left, 
                right
              ));
            ...
            if (prec > 0) {
              ...
              while (true) {
                ...
                while (stack.length > 2 && prec <= precedences[precedences.length - 1]) {
                  ...
                  stack.push(this.finalize(node, new Node.BinaryExpression(
                    operator, 
                    left, 
                    right
                  )));
              ...
              while (i > 1) {
                ...
                expr = this.finalize(node, new Node.BinaryExpression(
                  operator, 
                  stack[i - 2], 
                  expr
                ));
          ...
          Parser.prototype.parseConditionalExpression = function () {
            ...
            if (this.match('?')) {
              ...
              expr = this.finalize(this.startNode(startToken), new Node.ConditionalExpression(
                expr, 
                consequent, 
                alternate
              ));
            ...
            if (!this.context.allowYield && this.matchKeyword('yield')) {
              ...
              if (expr.type === ArrowParameterPlaceHolder || this.match('=>')) {
                ...
                if (list) {
                  ...
                  expr = isAsync 
                    ? this.finalize(node, new Node.AsyncArrowFunctionExpression(
                      list.params, 
                      body, 
                      expression
                    ))
                    : this.finalize(node, new Node.ArrowFunctionExpression(
                      list.params, 
                      body, 
                      expression
                    ));
                ...
                if (this.matchAssign()) {
                  ...
                  expr = this.finalize(this.startNode(startToken), new Node.AssignmentExpression(
                    operator, 
                    expr, 
                    right
                  ));
          ...
          Parser.prototype.parseForStatement = function () {
            ...
            return typeof left === 'undefined' 
              ? this.finalize(node, new Node.ForStatement(
                init, 
                test, 
                update, 
                body
              ...
              : forIn 
                ? this.finalize(node, new Node.ForInStatement(
                  left, 
                  right, 
                  body
                ))
                : this.finalize(node, new Node.ForOfStatement(
                  left, 
                  right, 
                  body
                ));
          ...
          Parser.prototype.parseTryStatement = function () {
            ...
            return this.finalize(node, new Node.TryStatement(
              block, 
              handler, 
              finalizer
            ));
          ...
          Parser.prototype.parseFunctionDeclaration = function (identifierIsOptional) {
            ...
            this.context.allowYield = previousAllowYield;
            return isAsync 
              ? this.finalize(node, new Node.AsyncFunctionDeclaration(
                id, 
                params, 
                body
              ))
              : this.finalize(node, new Node.FunctionDeclaration(
                id, 
                params, 
                body, 
                isGenerator
          ...
          Parser.prototype.parseFunctionExpression = function () {
            ...
            this.context.allowYield = previousAllowYield;
            return isAsync 
              ? this.finalize(node, new Node.AsyncFunctionExpression(
                id, 
                params, 
                body
              ))
              : this.finalize(node, new Node.FunctionExpression(
                id, 
                params, 
                body, 
                isGenerator
          ...
          Parser.prototype.parseClassElement = function (hasConstructor) {
            ...
            return this.finalize(node, new Node.MethodDefinition(
              key, 
              computed, 
              value, 
              kind, 
          ...
          Parser.prototype.parseClassDeclaration = function (identifierIsOptional) {
            ...
            this.context.strict = previousStrict;
            return this.finalize(node, new Node.ClassDeclaration(
              id, 
              superClass, 
              classBody
            ));
          ...
          Parser.prototype.parseClassExpression = function () {
            ...
            var classBody = this.parseClassBody();
            this.context.strict = previousStrict;
            return this.finalize(node, new Node.ClassExpression(
              id, 
              superClass, 
              classBody
            ));
        ...
        var Scanner = (function () {
          ...
          Scanner.prototype.skipMultiLineComment = function () {
            ...
            while (!this.eof()) {
              var ch = this.source.charCodeAt(this.index);
              if (character_1.Character.isLineTerminator(ch)) {
                if (ch === Ox0D && this.source.charCodeAt(this.index + 1) === Ox0A) {
                  ++this.index;
                }
                ++this.lineNumber;
                ++this.index;
                ...
                if (this.source.charCodeAt(this.index + 1) === Ox2F) {
                  this.index += 2;
                  if (this.trackComment) {
                    loc.end = { line: this.lineNumber, column: this.index - this.lineStart };
                    var entry = { 
          ...
          Scanner.prototype.scanComments = function () {
            ...
            while (!this.eof()) {
              ...
              if (character_1.Character.isWhiteSpace(ch)) {
                ...
                ++this.index;
                if (ch === Ox0D && this.source.charCodeAt(this.index) === Ox0A) {
                  ++this.index;
                }
                ++this.lineNumber;
                this.lineStart = this.index;
              ...
              } else if (start && ch === Ox2D) {
                if (this.source.charCodeAt(this.index + 1) === Ox2D && this.source.charCodeAt(this.index + 2) === Ox3E) {
                  this.index += 3;
          ...
          Scanner.prototype.codePointAt = function (i) {
            ...
            if (cp >= OxD800 && cp <= OxDBFF) {
              var second = this.source.charCodeAt(i + 1);
              if (second >= OxDC00 && second <= OxDFFF) {
                var first = cp;
                cp = (first - OxD800) * Ox400 + second - OxDC00 + Ox10000;
              }
            }
            return cp;
          };
          ...
          Scanner.prototype.getComplexIdentifier = function () {
            ...
            var ch;
            if (cp === Ox5C) {
              if (this.source.charCodeAt(this.index) !== Ox75) {
                this.throwUnexpectedToken();
              }
              ++this.index;
          ...
          Scanner.prototype.scanIdentifier = function () {
            var type;
            var start = this.index;
            var id = this.source.charCodeAt(start) === Ox5C 
          ...
          Scanner.prototype.testRegExp = function (pattern, flags) {
            ...
            if (flags.indexOf('u') >= 0) {
              tmp = tmp.replace(/\\u\{([0-9a-fA-F]+)\}|\\u([a-fA-F0-9]{4})/, function (
                $0, 
                $1, 
                $2
              ) {
                var codePoint = parseInt($1 || $2, 16);
                if (codePoint > Ox10FFFF) {
          ...
          Scanner.prototype.lex = function () {
            ...
            if (cp === Ox60 || cp === Ox7D && this.curlyStack[this.curlyStack.length - 1] === '${') {
              return this.scanTemplate();
            }
            if (cp >= OxD800 && cp < OxDFFF) {
            ...
            if (this.buffer.length === 0) {
              ...
              if (this.scanner.trackComment) {
                for (var i = 0; i < comments.length; ++i) {
                  ...
                  var comment = { type: e.multiLine 
                    ? 'BlockComment'
                    : 'LineComment', value: value };
                  if (this.trackRange) {
