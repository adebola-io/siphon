...
function watcher() {
    ...
    if ((0, fs_1.existsSync)("spnconfig.json")) {
        options = (0, tslib_1.__assign)((0, tslib_1.__assign)({}, defaults_1.default), require(path.resolve("spnconfig.json")).bundlerOptions);
    }
    /**
     * Core bundler.
     */
    ...
    console.log("".concat("".concat((0, dating_1.newTimeStamp)({
        noDate: true,
    }), ":").gray).concat(" Staging Files and starting bundler...".yellow));
}
